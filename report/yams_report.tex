...
standard string library.  In \texttt{string.asm}, we implemented
...
test code in \texttt{test\_string.asm}.  They can be run in MARS by loading that
file as the main file, instead of \texttt{main.asm}.
